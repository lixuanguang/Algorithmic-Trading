%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Base LaTeX Template for Algorithmic Trading Notes
% This file serves as a central preamble with package imports, custom macros,
% theorem environments, and styles for algorithms and code listings.
%
% (Adjust or remove the \documentclass declaration if this file is intended
...
\usetikzlibrary{calc}        % Added TikZ calc library for coordinate calculations
