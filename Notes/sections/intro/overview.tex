...
\input{sections/intro/alphamod}

\input{sections/intro/riskmod}

\input{sections/intro/txncostmod}

\input{sections/intro/portconstmod}

\input{sections/intro/executionmod}

\input{sections/intro/research}

\input{sections/intro/modelrisk}
